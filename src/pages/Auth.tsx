  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center p-4">
        ...
        >
          <Card className="glass-panel border-primary/20 p-8 shadow-2xl shadow-primary/20">
            <div className="mb-8 text-center">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{ type: 'spring', stiffness: 200, delay: 0.2 }}
                className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-primary to-chart-2 shadow-lg shadow-primary/30"
              >
            ...
            <Tabs defaultValue="signin" className="w-full">
              <TabsList className="glass-panel grid w-full grid-cols-2">
